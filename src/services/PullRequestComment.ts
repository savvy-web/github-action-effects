...
/**
 * Service interface for PR comment operations.
 *
 * @public
 */
...
/**
 * PullRequestComment tag for dependency injection.
 *
 * @public
 */
export const PullRequestComment = Context.GenericTag<PullRequestComment>("PullRequestComment");
